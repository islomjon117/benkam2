...
import "../drop_down2/dropdown2.css";

import { GoArrowDownRight } from "react-icons/go";

const dropdownItems = [
  {
    title: "CARDBOARD CONTAINERS",
  ...
  {
    title: "WRAPPING (single-piece or multiple aluminium profiles)",
  ...
  {
    title: "INTERLAYER (paper or plastic)",
    text: "Aluminum alloy 6082 is most widely used in construction. Usually, this alloy is the main building aluminum alloy for both welded structures and structures without the use of welding. Alloy 6082 is a high-strength alloy, which is used in various types of aluminum rolled products.",
  },
  {
    title: "ZIG-ZAG PROTECTION (paper or plastic)",
    text: "Aluminum alloy 6082 is most widely used in construction. Usually, this alloy is the main building aluminum alloy for both welded structures and structures without the use of welding. Alloy 6082 is a high-strength alloy, which is used in various types of aluminum rolled products.",
  },
  {
    title: "ADDITIONAL PROTECTION (wooden)",
    text: "Aluminum alloy 6082 is most widely used in construction. Usually, this alloy is the main building aluminum alloy for both welded structures and structures without the use of welding. Alloy 6082 is a high-strength alloy, which is used in various types of aluminum rolled products.",
  },
];
...
const Dropdown2 = () => {
  ...
  return (
    <div className="supplies_dropdown">
      <div className="container">
        {dropdownItems.map((item, index) => (
          <div
            key={index}
            className={`supplies_drop_down_box1 ${openIndex === index ? "open" : ""}`}
          >
            <div className="supplies_dropdown_left">
              <h1 
                onClick={() => setOpenIndex(openIndex === index ? null : index)} 
                style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}
              >
                {item.title} 
                <span className={`supplies_dropdownarrow ${openIndex === index ? "rotate" : ""}`}>
                  <GoArrowDownRight />
                </span>
              </h1>
            </div>
            <div className="supplies_dropdown_right">
              <p>{item.text}</p>
